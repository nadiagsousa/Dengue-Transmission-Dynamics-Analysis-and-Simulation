...
CL0=2000//quatidade de criadouros iniciais
...
controle_mecanico=[t',x']
fprintfMat('controle_mecanico.xls',controle_mecanico)
acumulado_mecanico=[tt',Calc,D_2020]
fprintfMat('acumulado_mecanico.xls',acumulado_mecanico)
