...
for i=2:length(t)
  ...
  // Larvicida 
    if t(i)>=30/30 & t(i)<=80/30 then
      miLL=0//0.058*365/12 //milL=2 
      mipL=0//0.058*365/12
  else
      miLL=0 
      mipL=0
...
com_mosquitos_mod=[t',x']
fprintfMat('com_mosquitos_mod.xls',com_mosquitos_mod)
acumulado_com_mosquitos_mod=[tt',Calc,D_2020]
fprintfMat('acumulado_com_mosquitos_mod.xls',acumulado_com_mosquitos_mod)
