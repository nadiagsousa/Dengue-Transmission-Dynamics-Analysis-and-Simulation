...
controle_inseticida=[t',x']
fprintfMat('controle_inseticida.xls',controle_inseticida)
acumulado_inseticida=[tt',Calc,D_2020]
fprintfMat('acumulado_inseticida.xls',acumulado_inseticida)
